...
public class CurrencyConvert {
	...
	public static void receive(){
		System.out.println("How Would You Like Your Money Distributed To You?");
	...
	//Asks the user if they would like to make another exchange
	public static void anotherExchange(){
		System.out.println("Would You Like To Make Another Exchange? \nSelect 1 for Yes and 2 for No");
		
		int exchange = console.nextInt();
		if (exchange == 1){
			promptUser();
			receive();
		}
		if (exchange == 2){
			System.out.println("Thank you for using the Canadian Currency Converter, Have a Nice Day.");}
	}
